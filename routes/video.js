...
import { HistroyController, getAllHistroyController,deleteHistroyController } from '../controllers/Histroy.js';
...
routes.post("/Histroy",auth,HistroyController);
routes.get("/getAllHistroy",getAllHistroyController);
routes.delete("/deleteHistroy/:userId",auth,deleteHistroyController);
